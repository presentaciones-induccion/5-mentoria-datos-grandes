...
![](imagenes/table_persona_variables_02.png){width="80%"}
...
![](imagenes/table_persona_variables_03.png){width="80%"}
...
![](imagenes/table_persona_variables_04.png){width="80%"}
...
|                      |                                                                  |
+----------------------+------------------------------------------------------------------+
| Apache Arrow         | Implementación de Arrow en R (analítica usando *dplyr*).         |
